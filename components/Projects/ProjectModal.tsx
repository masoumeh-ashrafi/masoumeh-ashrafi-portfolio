...
export default function ProjectModal({ project, onClose }: ProjectModalProps) {
  ...
  const architectureLayers = [
    { title: 'Frontend', items: project.architecture.frontend, color: 'border-blue-500/30' },
    { title: 'Backend', items: project.architecture.backend, color: 'border-emerald-500/30' },
    { title: 'Auth', items: project.architecture.auth, color: 'border-purple-500/30' },
    { title: 'Database', items: project.architecture.database, color: 'border-amber-500/30' },
  ]
